...
## [2.2.2] 2020-12-14
### BugFixing
- Update PerfectScrollbar Plugin

## [2.2.0] 2020-12-11
### BugFixing, Improvements
- Hide the Sidebar opened siblings collapse
- Solve the DataTable button error
- Move demo scripts into main JS file
- Solve CSP Violation Error
- Fix PerfectScrollbar error on Windows - fixed-plugin
- Configure hard coded colors to work with variables
- Fix navbar responsive problem from documentation
- Add sidebar image for the template.html file
- Create new styling for the long content pages
